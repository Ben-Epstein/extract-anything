...
class BamlStreamClient:
    ...
    def AnalyzeNDARisks(
        ...
        nda: types.NDA,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.RiskAnalysis, types.RiskAnalysis]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.RiskAnalysis, types.RiskAnalysis](
        raw,
    ...
    def ExtractNDA(
        ...
        document: Union[str, baml_py.Image, List[baml_py.Image]],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.NDA, types.NDA]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.NDA, types.NDA](
        raw,
    ...
    def TrackDeadlines(
        ...
        nda: types.NDA,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.DeadlineReport, types.DeadlineReport]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.DeadlineReport, types.DeadlineReport](
        raw,
