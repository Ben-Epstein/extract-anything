...
class TypeBuilder(_TypeBuilder):
    def __init__(self):
        super().__init__(classes=set(
          ["Address","ConfidentialInformation","ContactPerson","DeadlineReport","DisputeResolution","Duration","Exhibit","Milestone","NDA","Obligation","Party","Remedy","Response","Risk","RiskAnalysis","Schema","Signature",]
        ), enums=set(
          ["AgreementType","PartyRole","RiskLevel","TimeUnit",]
...
class ResponseBuilder:
    def __init__(self, tb: _TypeBuilder):
        ...
        self.__bldr = _tb.class_("Response")
        self.__properties: typing.Set[str] = set([])
        self.__props = ResponseProperties(self.__bldr, self.__properties)
